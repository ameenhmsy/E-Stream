...
<html lang="fr">
   ...
   <body>
      ...
      <main>
      <div class="container">
         <div class="jumbotron container pb-video-container">
            <div class="col-md-6 px-0">
               <h1 class="display-4 font-italic">Nouveautés de Qualité UHD </h1>
               <p class="lead my-3" id="headerP">Profitez d'une expérience agréable et choisissez parmis une sélection à jour et variée pour tous les goûts 
                  votre film préféré sur votre plateforme préférée <b> E-<span style="color:#33cabb">Stream</span></b>.🎞</p>
            </div>
      ...
      <div class="container">      
         <div class="container pb-video-container rounded">
            <h2>&nbsp;&nbsp;<img src="./image/play.jpg" alt=".." width="2.4%" height="5%" style="border-radius:20%;"> Meilleurs Ventes </h2> 

            <div class="movie-card card col-sm-3 col-md-3 pb-video">
               <img src="https://www.joblo.com/assets/images/joblo/posters/2019/02/captin-marvel-poster-international.jpg" class="card-img-top" alt="..." width="100%" height="340">
               ...
               <div class="pmain">
                  <div class="movie-content-header">
                     <a href="#">    <h3 class="movie-title">Man of Steel</h3>  </a>
                     <div class="imax-logo"></div>
                  </div>
                  <div class="movie-info">
                     <div class="info-section"> <!--date,time-->
                        <label>Date & Time</label>  <span>Sun 8 Sept - 10:00PM</span>
                     </div>
                     <div class="info-section"> <!--screen-->
                        <label>Screen</label>       <span>03</span>
                     </div>
                     <div class="info-section"> <!--row-->
                        <!-- <label>Row</label>          <span>F</span> -->
                     </div>
                  </div>
               </div>
            </div><!--movie-card-->             

            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <li>
                  <a data-toggle="dropdown" class="btn btn-primary dropdown-toggle get-started-btn mt-1 mb-1" href="#">
                     <b id="conn1">&nbsp;CONNEXION &nbsp;<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-unlock"
               ...
               <li>
                  <a id="newMbr" href="#" data-toggle="dropdown"
                     ...
                     <b> Devenir Membre &nbsp;<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-plus"
                             fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                           <path fill-rule="evenodd"

...
<html>
   ...
   <body>
      ...
      <!-- <div class="container pb-video-container rounded">  | <div class="container bg-info"> -->
      <div class="container">
         <div class="jumbotron p-3 p-md-5 mb-0 text-center rounded bg-dark container pb-video-container">
            <h2 id="headerCateg">Films de Comédie</h2>
         </div>
         ...
         <div class="container pb-video-container rounded">         
            <div> <!-- *************************************************************** -->
               <?php 
                  ...
                  $rslt = $currentViewerCtg->viewCateg("Comédie");
                  foreach($rslt as $elm) {
               ?> 
